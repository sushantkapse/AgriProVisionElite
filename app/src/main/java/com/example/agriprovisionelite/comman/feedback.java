    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean res= db.insertFarmerfeedback(name1,bf.toString(),suggetion);

                if(res==true){
                    Toast.makeText(getApplicationContext(), " feedback details save successfully", Toast.LENGTH_LONG).show();
