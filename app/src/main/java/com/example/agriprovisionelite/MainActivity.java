...
import com.example.agriprovisionelite.Admin.AdminHomePageDashBoard;
import com.example.agriprovisionelite.Attendance.AttendaceHome;
import com.example.agriprovisionelite.Krishi_Officer.Farmer_DashBoard;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button feedbck,admin,farmerR,farmerL,KR,KL,news,wheather,ml,attendance,call,allFarmer,dash,b1,testing;
...
attendance.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        ...
        allFarmer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i =new Intent(MainActivity.this, AdminHomePageDashBoard.class);
                startActivity(i);
        ...
        testing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i =new Intent(MainActivity.this, Farmer_DashBoard.class);
                startActivity(i);
            }
        });
