...
public class Wheather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ActivityCompat.checkSelfPermission(this,Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this,Manifest.permission.ACCESS_COARSE_LOCATION)!=PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(Wheather.this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION,Manifest.permission.ACCESS_COARSE_LOCATION},PERMISSION_CODE);
        }
        ...
        searchIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (city.isEmpty()) {
                    Toast.makeText(Wheather.this, "Please enter city name", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void getWeatherInfo(String cityName) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Wheather.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Wheather.this, "Enter a valid city name..", Toast.LENGTH_SHORT).show();
            }
        });
